...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    print("Bitcoin Address: " +
        wallet.getAddressForCoin(TWCoinType.TWCoinTypeBitcoin).toString());
    print("Litecoin Address: " +
        wallet.getAddressForCoin(TWCoinType.TWCoinTypeLitecoin).toString());
    print("Ethereum Address: " +
        wallet.getAddressForCoin(TWCoinType.TWCoinTypeEthereum).toString());
    print("Solana Address: " +
        wallet.getAddressForCoin(TWCoinType.TWCoinTypeSolana).toString());
    print("Stellar Address: " +
        wallet.getAddressForCoin(TWCoinType.TWCoinTypeStellar).toString());
  }
